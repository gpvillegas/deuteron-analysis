...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  7 14:31:59 2025
...
skf_meas = SIMC.Branches['e_pf']*(1/1e3)

# measured proton final momentum in GeV
Pf_meas = RUN.Branches['H.gtr.p']
sPf_meas = SIMC.Branches['h_pf']*(1/1e3)

#%% calculated quantiies

Ef = np.sqrt(Mp*Mp + Pf_meas*Pf_meas)
Em_calc = Eb + Mp - Ef - kf_meas

sEf = np.sqrt(Mp*Mp + sPf_meas*sPf_meas)
sEm_calc = Eb + Mp - sEf - skf_meas
